...
for file in K562_train_*.bed.gz; do
...
for file in A549_train_*.bed.gz; do
	var=$(echo $file | awk -F"." '{print $1}')
	set -- $var
	echo $1
...
for file in HepG2_train_*.bed.gz; do
	var=$(echo $file | awk -F"." '{print $1}')
	set -- $var
	echo $1
...
for file in MCF7_train_*.bed.gz; do
	var=$(echo $file | awk -F"." '{print $1}')
	set -- $var
	echo $1
