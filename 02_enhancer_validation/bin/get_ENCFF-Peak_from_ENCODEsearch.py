...
""", formatter_class = argparse.RawTextHelpFormatter)
    ...
    parser.add_argument('--preferred', action='store_true', help='only return files with preferred_default=="true"')
...
if __name__ == '__main__':
    ...
    for data in payload:
        ...
        # Skip if preferred set and sample not preferred
        if (args.preferred and not data.get('preferred_default', False)):
            continue
