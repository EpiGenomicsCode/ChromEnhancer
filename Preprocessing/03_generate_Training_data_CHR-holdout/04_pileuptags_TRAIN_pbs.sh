...
for file in A549*.pbs; do qsub $file; done
for file in HepG2*.pbs; do qsub $file; done
for file in K562*.pbs; do qsub $file; done
for file in MCF7*.pbs; do qsub $file; done
